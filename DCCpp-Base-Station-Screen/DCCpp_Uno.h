...
#ifdef ARDUINO_AVR_MEGA                   // si utiliza Mega 1280, define como Mega 2560 (los pinouts y la funcionalidad son idénticos)
  #define ARDUINO_AVR_MEGA2560
#endif

#if defined  ARDUINO_AVR_UNO
#error CANNOT COMPILE - DCC++ OLED SCREEN ONLY USE MEGA 
  #define ARDUINO_TYPE    "UNO"

  #define DCC_SIGNAL_PIN_MAIN 10          // Ardunio Uno  - usa OC1B
  #define DCC_SIGNAL_PIN_PROG 5           // Arduino Uno  - usa OC0B

  #if COMM_INTERFACE != 0                 // Serial no ha sido seleccionado
  ...
  #define DCC_SIGNAL_PIN_MAIN 12          // Arduino Mega - usa OC1B
  #define DCC_SIGNAL_PIN_PROG 2           // Arduino Mega - usa OC3B
